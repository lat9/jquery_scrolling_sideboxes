...
//
$show_specials = !(isset ($_GET['products_id']));
if ($show_specials == true) {
  $scrolling_specials_sql = "SELECT p.products_id, pd.products_name, p.products_image, p.master_categories_id
  ...
  $scrolling_specials = $db->ExecuteRandomMulti ($scrolling_specials_sql, MAX_RANDOM_SELECT_SPECIALS);
