...
while (!$best_sellers_scrolling->EOF) {
    ...
    $content .= '<a href="' . zen_href_link(zen_get_info_page($bss_pid), "products_id=$bss_pid") . '">' . zen_image(DIR_WS_IMAGES . $best_sellers_scrolling->fields['products_image'], $bss_name, SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT);
